...
<form action="{{ route('courses.store')}}" method="post" class="card card-dark mx-3">
    @csrf
              ...
              <div class="card-body">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="number" name="cost" value="" class="form-control" placeholder="cost">
                </div>
                </div>
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="number" name="hours" value="" class="form-control" placeholder="hours">
                </div>
                </div>
