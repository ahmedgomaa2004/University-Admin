...
<form action="{{ route('doctors.store')}}" method="post" class="card card-info mx-3">
    @csrf
              ...
              <div class="card-body">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="number" name="salary" value="" class="form-control" placeholder="salary">
                </div>
                </div>
                ...
                <div class="form-group">
                <button type="submit" class="btn btn-block btn-info btn-lg" style="width: 150px;">Add</button>
                </div>
